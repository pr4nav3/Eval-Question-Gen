...
- *why* a regulator, court, or party took a particular position or reached a conclusion;
- *how* a rule, condition, or test was applied to the facts in the chunks;
- *what reasoning or legal principle* supports a holding, denial, or direction;
- *what relationship* exists between two provisions, arguments, orders, or findings in the chunks;
- *what inference* follows from combining two facts that are stated separately;
- *whether* a stated conclusion is consistent with another part of the document;
- *what tension, conflict, or distinction* arises between two positions in the chunks;
- *how a change in a key fact* would alter the analysis, provided the chunks contain enough
  information to answer without speculation.

Reasoning verbs and phrasings that tend to produce good questions include:
*explain, analyze, evaluate, assess, determine whether, compare, contrast, connect,
relate, justify, infer, interpret, trace, reconcile, distinguish, apply, resolve,
what led to, what follows from, what does this imply, on what grounds, under what
...
- a bare procedural chronology unless the answer requires explaining its legal significance.

Grounding rule: the answer must be directly supported by the allowed chunks.
If the document does not state the reasoning for a "why" or "how" question, do not
invent it; choose a different gap or write zero rows. Do not ask hypothetical
"what if" questions unless the chunks already contain the materials needed to answer.
